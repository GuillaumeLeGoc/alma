...
from Functions import ConfigFunctions, FootfallFunctions
...
class AnalyzeFootfallPanel(wx.Panel):
    def __init__(self, parent):
        ...
        (
            ...
            configs["window_width"],
            configs["window_height"],
            configs["frame_rate"],
            configs["likelihood_threshold"],
            configs["depth_threshold"],
            configs["threshold"],
        )
        ...
        self.sizer_1.Add(
            self.header, pos=(0, 0), span=(1, 5), flag=wx.LEFT | wx.TOP, border=25
        )

        self.instructions = wx.StaticText(
            self,
            -1,
            "Load the csv file of bodypart coordinates (e.g., from DLC) and validate detected footfalls.",
            size=(self.window_width, 30),
        )
        font = wx.Font(15, wx.MODERN, wx.NORMAL, wx.NORMAL)
        self.instructions.SetFont(font)
        self.sizer_1.Add(
            self.instructions, pos=(1, 0), span=(1, 5), flag=wx.LEFT, border=25
        )
    ...
    def MakePrediction(self, e):
        ...
        n_pred, depth_pred, t_pred, start_pred, end_pred, bodypart_list_pred = (
            0,
            [],
            [],
            [],
        ...
        for bodypart in self.selected_bodyparts:
            (
                ...
                start_pred_temp,
                end_pred_temp,
            ) = FootfallFunctions.find_footfalls(
                self.df,
                bodypart,
                "y",
                panel=self,
    ...
    def ImportVideo(self, e):
        import_dialog = wx.FileDialog(
            ...
            self.dirname,
            "",
            "Video files (*.avi)|*.avi|Video files (*.mp4)|*.mp4|Video files (*.webm)|*.webm|Video files (*.mov)|*.mov|All files(*.*)|*.*",
            wx.FD_OPEN,
        )
...
if you wish to analyze footfall duration.")
    ...
    def MarkFrame(self, e, mark_type):
        ...
        # that matches the frame to be labelled as start/end of footfall
            ...
            _, self.next_val_confirmed = FootfallFunctions.find_confirmed_neighbors(
            ...
            self.prev_val_confirmed, _ = FootfallFunctions.find_confirmed_neighbors(
    ...
    def OnSliderScroll(self, e):
        ...
        if self.n_frame > self.prev_pred and self.n_frame < self.t_pred[self.t_pred_id]:
            ...
            self.n_frame < self.next_pred and self.n_frame > self.t_pred[self.t_pred_id]
        ):
            self.prev_pred = self.t_pred[self.t_pred_id]
    ...
    def Footfall_UI_1(self):
        ...
        self.sizer_1.Add(
            self.bodypart_choices, pos=(9, 2), flag=wx.LEFT | wx.TOP, border=25
        )
        self.bodypart_choices.Hide()
        ...
        self.sizer_1.Add(
            self.import_new_csv_button, pos=(10, 2), flag=wx.TOP | wx.BOTTOM, border=25
        )
        ...
        self.sizer_1.Add(
            self.import_video_button, pos=(11, 0), flag=wx.LEFT | wx.TOP, border=25
        )
        ...
        self.sizer_1.Add(
            self.import_video_text, pos=(11, 1), flag=wx.LEFT | wx.TOP, border=25
        )
        ...
        self.sizer_1.Add(
            self.validate_button, pos=(12, 1), flag=wx.TOP | wx.LEFT, border=25
        )
    ...
    def Footfall_UI_2(self):
        ...
        self.sizer_2.Add(
            ...
            pos=(7, 0),
            flag=wx.LEFT | wx.ALIGN_CENTER_VERTICAL | wx.BOTTOM,
            border=25,
        )
        ...
        self.sizer_2.Add(
            self.frame_canvas, pos=(8, 0), span=(6, 2), flag=wx.LEFT, border=25
        )
        ...
        self.sizer_2.Add(
            self.reject_button,
            pos=(8, 5),
            flag=wx.BOTTOM | wx.ALIGN_CENTER_VERTICAL | wx.LEFT,
            border=25,
        )
        ...
        self.Bind(
            wx.EVT_BUTTON,
            lambda event, new_frame="prev_pred": self.SwitchFrame(event, new_frame),
        ...
        self.Bind(
            wx.EVT_BUTTON,
            lambda event, new_frame="next_pred": self.SwitchFrame(event, new_frame),
        ...
        self.sizer_2.Add(
            ...
            pos=(9, 4),
            span=(0, 2),
            flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL | wx.LEFT,
            border=-15,
        )
        ...
        self.prev_button.Bind(
            wx.EVT_BUTTON,
            lambda event, new_frame=-1: self.SwitchFrame(event, new_frame),
        )
        self.sizer_2_widgets.append(self.prev_button)
        self.next_button = wx.Button(self, id=wx.ID_ANY, label=">")
        self.next_button.Bind(
            wx.EVT_BUTTON, lambda event, new_frame=1: self.SwitchFrame(event, new_frame)
        )
        ...
        self.prev10_button.Bind(
            wx.EVT_BUTTON,
            lambda event, new_frame=-10: self.SwitchFrame(event, new_frame),
        )
        ...
        self.sizer_2.Add(
            ...
            pos=(10, 3),
            span=(0, 1),
            flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL | wx.TOP,
            border=10,
        )
        self.sizer_2.Add(
            self.slider_label,
        ...
        self.start_check_box.Bind(
            wx.EVT_CHECKBOX,
            lambda event, mark_type="start": self.MarkFrame(event, mark_type),
        )
        self.sizer_2.Add(
            self.start_check_box,
            pos=(11, 2),
            span=(0, 2),
            flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL | wx.TOP,
            border=20,
        ...
        self.val_check_box.Bind(
            wx.EVT_CHECKBOX,
            lambda event, mark_type="confirmed": self.MarkFrame(event, mark_type),
        )
        self.sizer_2.Add(
            self.val_check_box,
            pos=(11, 4),
        ...
        self.to_start_button.Bind(
            wx.EVT_BUTTON,
            lambda event, new_frame="start": self.SwitchFrame(event, new_frame),
        )
        self.sizer_2.Add(
        ...
        self.to_end_button.Bind(
            wx.EVT_BUTTON,
            lambda event, new_frame="end": self.SwitchFrame(event, new_frame),
        )
        self.sizer_2.Add(
            self.to_end_button,
            pos=(12, 6),
        ...
        self.slider = wx.Slider(
            self,
            value=self.n_frame + 1,
            minValue=1,
            maxValue=len(self.df),
        ...
        self.sizer_2.Add(
            ...
            pos=(15, 0),
            span=(2, 8),
            flag=wx.LEFT | wx.EXPAND | wx.TOP | wx.RIGHT,
            border=25,
        )
        ...
        self.likelihood_label = wx.StaticText(
            self,
            label="Set likelihood threshold (data below threshold are labeled grey; between 0 and 1)",
        )
        self.sizer_2.Add(
    ...
    def DisplayFootfall_UI_1(self, e):
        ...
        self.header.SetFont(font)
        self.sizer_1.Add(
            self.header, pos=(0, 0), span=(2, 5), flag=wx.LEFT | wx.TOP, border=25
        )

        self.instructions = wx.StaticText(
            self,
            -1,
            "Load the csv file of bodypart coordinates and validate detected footfalls.",
        )
        self.sizer_1.Add(
            self.instructions,
            pos=(2, 0),
    ...
    def OnMethod(self, e):
        self.selected_bodyparts = [
            self.bodyparts[i] for i in list(self.bodypart_choices.GetCheckedItems())
        ]
        self.method_selection = self.method_choices.GetValue()
