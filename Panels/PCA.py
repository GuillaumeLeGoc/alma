...
class PCAPanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.sizer.Add(
            self.instructions, pos=(2, 0), span=(1, 6), flag=wx.LEFT, border=25
        )
        ...
        self.sizer.Add(
            self.select_group1_button, pos=(3, 0), flag=wx.LEFT | wx.TOP, border=25
        )
        ...
        self.sizer.Add(
            self.select_group1_text, pos=(3, 1), flag=wx.LEFT | wx.TOP, border=25
        )
        self.data_widgets.append(self.select_group1_text)
        #################################
        self.select_group2_button = wx.Button(self, id=wx.ID_ANY, label="Group 2")
        self.sizer.Add(
            self.select_group2_button, pos=(4, 0), flag=wx.LEFT | wx.TOP, border=25
        )
        ...
        self.sizer.Add(
            self.select_group2_text, pos=(4, 1), flag=wx.LEFT | wx.TOP, border=25
        )
        self.data_widgets.append(self.select_group2_text)
        #################################
        self.select_group3_button = wx.Button(self, id=wx.ID_ANY, label="Group 3")
        self.sizer.Add(
            self.select_group3_button, pos=(5, 0), flag=wx.LEFT | wx.TOP, border=25
        )
        ...
        self.sizer.Add(
            self.select_group3_text, pos=(5, 1), flag=wx.LEFT | wx.TOP, border=25
        )
    ...
    def SelectGroupFolder(self, e, group_no):
        ...
        if import_dialog.ShowModal() == wx.ID_OK:
            ...
            if group_no == 0:
                ...
                self.sizer.Add(
                    self.group1_name_input, pos=(3, 2), flag=wx.LEFT | wx.TOP, border=25
                )
                ...
                self.Bind(
                    wx.EVT_BUTTON,
                    lambda event, group_no=0: self.OnGroupNameInput(event, group_no),
                ...
                self.sizer.Add(
                    self.group2_name_input, pos=(4, 2), flag=wx.LEFT | wx.TOP, border=25
                )
                ...
                self.Bind(
                    wx.EVT_BUTTON,
                    lambda event, group_no=1: self.OnGroupNameInput(event, group_no),
                ...
                self.folder3 = path
                self.select_group3_text.SetLabel(
                    f"Data folder of the third group: \n{path}"
                )

                self.group3_name_input = wx.TextCtrl(self, value="")
                self.sizer.Add(
                    self.group3_name_input, pos=(5, 2), flag=wx.LEFT | wx.TOP, border=25
                )
                self.data_widgets.append(self.group3_name_input)
                self.group3_name_input.Show()

                self.group3_name_input_button = wx.Button(
                    self, id=wx.ID_ANY, label="Confirm group name"
                )
                self.Bind(
                    wx.EVT_BUTTON,
                    lambda event, group_no=2: self.OnGroupNameInput(event, group_no),
                    self.group3_name_input_button,
                )
                self.sizer.Add(
                    self.group3_name_input_button,
                    pos=(5, 3),
    ...
    def SelectOutputFolder(self, e):
        ...
        if export_dialog.ShowModal() == wx.ID_OK:
            ...
            self.sizer.Add(
                self.output_path_text, pos=(7, 2), flag=wx.LEFT | wx.TOP, border=25
            )
            self.data_widgets.append(self.output_path_text)

            self.PCA_button = wx.Button(
                self, id=wx.ID_ANY, label="Run principal component analysis"
            )
            self.sizer.Add(
                self.PCA_button, pos=(8, 1), flag=wx.LEFT | wx.TOP, border=25
            )
    ...
    def PCA(self, e):
        ...
        if self.folder1 != "":
            ...
            self.PCA_result_text.SetLabel(
                "Please enter or confirm the name of group 1!"
            )
        ...
        if self.folder2 != "":
            ...
            self.PCA_result_text.SetLabel(
                "Please enter or confirm the name of group 2!"
            )
        ...
        combined_df = DataAnalysisFunctions.combine_files(
            file_lists, group_names, self.output_path, "average"
        )
        ...
        try:
            ...
            self.sizer.Add(
                self.PCA_result_text, pos=(8, 2), flag=wx.LEFT | wx.TOP, border=25
            )
